...
const projects: Project[] = [
  {
    ...
    description: 'A virtual art gallery built with Three.js featuring interactive 3D environments and dynamic lighting systems.',
  ...
  },
  {
    ...
    description: 'Award-winning portfolio website featuring custom animations and immersive scroll experiences.',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-body text-gray-light max-w-2xl mx-auto">
            A curated selection of my most impactful work, showcasing the intersection 
              ...
              <div className="project-card relative overflow-hidden rounded-2xl bg-dark border border-gray-800 hover:border-gray-600 transition-all duration-500">
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm text-gray-light font-medium">{project.subtitle}</span>
              ...
              >
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-gray-light font-medium">{selectedProject.subtitle}</span>
                  ...
                  <p className="text-gray-light leading-relaxed mb-6">{selectedProject.description}</p>
